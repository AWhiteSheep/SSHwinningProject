...
namespace Inscription
{
    ...
    partial void InsertAteliers_Tags(Ateliers_Tags instance);
    partial void UpdateAteliers_Tags(Ateliers_Tags instance);
    partial void DeleteAteliers_Tags(Ateliers_Tags instance);
	...
	public partial class Tags : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Ateliers_Tags> _Ateliers_Tags;
    ...
    partial void OnDescriptionChanged();
		...
		public Tags()
		{
			this._Ateliers_Tags = new EntitySet<Ateliers_Tags>(new Action<Ateliers_Tags>(this.attach_Ateliers_Tags), new Action<Ateliers_Tags>(this.detach_Ateliers_Tags));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Tags_Ateliers_Tags", Storage="_Ateliers_Tags", ThisKey="Description", OtherKey="Description")]
		public EntitySet<Ateliers_Tags> Ateliers_Tags
		{
			get
			{
				return this._Ateliers_Tags;
			}
			set
			{
				this._Ateliers_Tags.Assign(value);
			}
		}
		...
		private void attach_Ateliers_Tags(Ateliers_Tags entity)
		{
			this.SendPropertyChanging();
			entity.Tags = this;
		}
		
		private void detach_Ateliers_Tags(Ateliers_Tags entity)
		{
			this.SendPropertyChanging();
			entity.Tags = null;
		}
	...
	public partial class Ateliers_Tags : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnDescriptionChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Description", DbType="VarChar(25)", IsPrimaryKey=true)]
		public string Description
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Tags_Ateliers_Tags", Storage="_Tags", ThisKey="Description", OtherKey="Description", IsForeignKey=true)]
		public Tags Tags
		{
			get
			{
			...
			set
			{
							...
							|| (this._Tags.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Ateliers_Tags.Remove(this);
					}
					this._Tags.Entity = value;
					if ((value != null))
					{
						value.Ateliers_Tags.Add(this);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DonneesAteliers_Ateliers_Tags", Storage="_DonneesAteliers", ThisKey="NumAtelier", OtherKey="NumAtelier", IsForeignKey=true)]
    ...
    partial void OnConferencierChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DonneesAteliers_Ateliers_Tags", Storage="_Ateliers_Tags", ThisKey="NumAtelier", OtherKey="NumAtelier")]
		public EntitySet<Ateliers_Tags> Ateliers_Tags
		{
			get
			{
